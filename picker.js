...
/*
PickerHSL.prototype.createColor = function(color) {
    return d3.hsl(color.h, color.s, color.l);
}
*/
...
/*
PickerHSL.prototype.sliceColor = function(h, s, l)
{
    var _h = this.scaleRange(h, 0);
    var c = d3.hsl(_h, s, l);
    return c.toString();
...
/*
PickerHSL.prototype.getColor = function()
{
    var _h = this.scaleRange(this.gradientPos, 0);
    return d3.hsl(_h, this.slicePos[0], this.slicePos[1]);
}
*/

/*
PickerHSL.prototype.setLABColor = function(labColor)
{
    var hslColor = d3.hsl(labColor);
    this.gradientPos = this.revScaleRange(hslColor.h, 0);
    this.slicePos = [
...
PickerHSL.prototype.getColorFromLAB = function(labColor)
{
    return d3.hsl(labColor);
}
*/
 ...
 */
 ...
 /*
 PickerRGB.prototype.sliceColor = function(r, g, b)
 {
     var c = d3.rgb(
         this.scaleRange(r, 0),
         this.scaleRange(g, 1),
 ...
 PickerRGB.prototype.getColor = function()
 {
     var r = this.scaleRange(this.gradientPos, 0);
     var g = this.scaleRange(this.slicePos[0], 1);
     var b = this.scaleRange(this.slicePos[1], 2);
...
/*
PickerRGB.prototype.setLABColor = function(labColor)
{
     var rgbColor = d3.rgb(labColor);
     this.gradientPos = this.revScaleRange(rgbColor.r, 0);
     this.slicePos = [
         this.revScaleRange(rgbColor.g, 1),
         this.revScaleRange(rgbColor.b, 2)
     ];
     this.adjustGradientPos(this.gradientPos);
     this.adjustSlicePos(this.slicePos);
}
...
/*
 PickerHCL.prototype.getColor = function()
 {
     var _h = this.scaleRange(this.gradientPos, 0);
     var _c = this.scaleRange(this.slicePos[0], 1);
     var _l = this.scaleRange(this.slicePos[1], 2);
     return d3.hcl(_h, _c, _l);
 }
*/
/*
 PickerHCL.prototype.setLABColor = function(labColor)
 {
     var hclColor = d3.hcl(labColor);
     this.gradientPos = this.revScaleRange(hclColor.h, 0);
     this.slicePos = [
         this.revScaleRange(hclColor.c, 1),
         this.revScaleRange(hclColor.l, 2)
     ];
     this.adjustGradientPos(this.gradientPos);
     this.adjustSlicePos(this.slicePos);
 }
...
PickerLAB.prototype.getColor = function()
{
    var _l = this.scaleRange(this.gradientPos, 0);
    var _a = this.scaleRange(this.slicePos[0], 1);
    var _b = this.scaleRange(this.slicePos[1], 2);

    return d3.lab(_l, _a, _b);
}
*/

/*
PickerLAB.prototype.setLABColor = function(labColor)
{
    var lRange = LAB_RANGE[0].range;
    var aRange = LAB_RANGE[1].range;
    var bRange = LAB_RANGE[2].range;

    var gradPos = this.revScaleRange(labColor.l, 0);


    var slicePos = [
        this.revScaleRange(labColor.a, 1),
        this.revScaleRange(labColor.b, 2),
    ];
    this.gradientPos = gradPos;
    this.slicePos = slicePos;
    this.adjustGradientPos(this.gradientPos);
    this.adjustSlicePos(this.slicePos);
}

PickerLAB.prototype.getColorFromLAB = function(labColor) {
    return labColor;
}
*/
...
/*
PickerJAB.prototype.setLABColor = function(labColor)
{
    var jabColor = d3.jab(labColor)
    var gradPos = this.revScaleRange(jabColor.J, 0);
    var slicePos = [
        this.revScaleRange(jabColor.a, 1),
        this.revScaleRange(jabColor.b, 2)
    ];
    this.gradientPos = gradPos;
    this.slicePos = slicePos;
    this.adjustGradientPos(this.gradientPos);
...
PickerJAB.prototype.getColorFromLAB = function(labColor) {
    var c = d3.lab(labColor.l, labColor.a, labColor.b);
    if (c.l == 0) {
        c.l = 0.1;
    }
    return d3.jab(c);
